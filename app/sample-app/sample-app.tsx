...
import { H2 } from '@my-org/my-scope.ui.heading';
// import { InfoCard } from '@teambit/design.ui.content.info-card';
// import { Grid } from '@teambit/base-react.layout.grid';
import { Card } from '@my-org/my-scope.ui.cards.card';
import { ThemeToggler, ThemeSwitcher } from '@my-org/my-scope.themes.theme-toggler';
